  ...
  return (
    <div className="box">
      ...
      <div className='container'>
        ...
        <img src={require("./assets/drawers.jpg")} alt="furniture-img" className='furniture' />

        <div className='secondary-container'>
          <h1 className='heading'>Shift the overall look and feel by adding these wonderful touches to furniture in your home</h1>
          <p className='about'>Ever been in a room and felt slightly bare and uninviting .I've got some simple tips to help you make any room feel complete.</p>
          <footer className="tertiary-container">
            <img src={require("./assets/avatar-michelle.jpg")} alt="avatar" className='avatar' />
            <div className="text">
              <h2 className='name'>Michelle Appleton</h2>
              <p className='time'>28 Jun 2020</p>
            </div>
            <button className='share' onClick={()=>setVisible(!visible)}>
        ...
        {<div className={(visible)?'shareitems':"no-shareitems"}>
            <h2 className='tag'>SHARE</h2>
